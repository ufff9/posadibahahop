...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/rauf/pos-toko/public/storage' => 'string',
...
'view.paths','view.compiled','images.default','cors.paths','cors.allowed_methods',
'cors.allowed_origins','cors.allowed_origins_patterns','cors.allowed_headers','cors.exposed_headers','cors.max_age',
'cors.supports_credentials','app.name','app.env','app.debug','app.url',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/rauf/pos-toko/public/storage','logging.default','logging.deprecations.channel',
...
'session.serialization','boost.enabled','boost.rules.enabled','boost.rules.scoped_guidelines','boost.guidelines.exclude',
...
'mcp.authorization_server','mcp.tool_search.max_tool_calls','mcp.tool_search.max_output_bytes','blaze.enabled','blaze.debug',
...
'livewire.upload-file','livewire.preview-file','home','login','logout','barang',
'kategori','kasir','dashboard','laporan','struk',
'stok-masuk','riwayat','user','cetak-barcode','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'7e18002692bfbff6adb69979f86ce91f::cetak-barcode','7e18002692bfbff6adb69979f86ce91f::dashboard','7e18002692bfbff6adb69979f86ce91f::kasir','7e18002692bfbff6adb69979f86ce91f::kelola-barang','7e18002692bfbff6adb69979f86ce91f::kelola-kategori',
'7e18002692bfbff6adb69979f86ce91f::kelola-user','7e18002692bfbff6adb69979f86ce91f::laporan-penjualan','7e18002692bfbff6adb69979f86ce91f::login','7e18002692bfbff6adb69979f86ce91f::riwayat-transaksi','7e18002692bfbff6adb69979f86ce91f::stok-masuk',
'49e6ba0785ed6ce43a2be310b2a6a3a4::layouts.app','49e6ba0785ed6ce43a2be310b2a6a3a4::layouts.guest','cetak-barcode','components.layouts.app','components.layouts.guest',
'dashboard','kasir','kelola-barang','kelola-kategori','kelola-user',
'laporan-penjualan','layouts.app','layouts.guest','livewire.cetak-barcode','livewire.dashboard',
'livewire.kasir','livewire.kelola-barang','livewire.kelola-kategori','livewire.kelola-user','livewire.laporan-penjualan',
'livewire.login','livewire.riwayat-transaksi','livewire.stok-masuk','login','riwayat-transaksi',
'stok-masuk','struk','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','mcp::authorize','mcp::components.app',
...
'SESSION_SECURE_COOKIE','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE',
